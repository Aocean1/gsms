...
public class Login extends JFrame {
    ...
    public void init() {
        ...
        JPanel panel1 = new JPanel() {//登录界面上半部分
            ...
            final ImageIcon image = new ImageIcon("Image\\up.png");//登录界面上部图片
        ...
        JPanel head = new JPanel() {//头像
            @Serial
            private static final long serialVersionUID = 1L;
            final ImageIcon icon = new ImageIcon("Image\\flower.jpg");
        ...
        password.addActionListener(_ -> login());//密码框添加回车登录事件，进入主菜单界面
